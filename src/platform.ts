...
export function findExecutable(base: string, extraDirs: string[] = []): string | undefined {
 ...
 */
export function resolveClaude(custom: string, claudeExtensionPath?: string): string {
...
export function runFile(
  ...
  return execFile(file, args, options, done);
}
...
export function nodeVersion(): Promise<string | undefined> {
