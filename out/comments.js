...
exports.requiredLengths = requiredLengths;
...
const DEFAULT = C_LIKE;
function rulesFor(languageId) {
 ...
 */
function findComment(line, rules) {
    let quote = null;
...
function requiredLengths(lines, languageId) {
